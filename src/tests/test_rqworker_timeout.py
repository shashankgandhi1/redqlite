...
def callback_fn(msg, **kwargs):
    print(f"Sleeping long for message {msg}")
    time.sleep(3)


rqworker_pool = RQWorkerPool(topic="allmsgs", timeout_ms=2000, callback=callback_fn, num_workers=2, serializer=StringSerializer)
